    ...
    return (
        <div
            ...
            MAIT
                ...
                <ul className="list-decimal pl-0 space-y-4 text-left mx-5">
                    <li className="flex items-start">
                        <span className="mr-2">&#8226;</span>
                        <p className="text-sm sm:text-2xl text-white font-semibold">
                            To cultivate students' interest in the field of management or commerce in
                            a convivial environment, without the pressure of being graded.
                        </p>
                    </li>
                    <li className="flex items-start">
                        <span className="mr-2">&#8226;</span>
                    ...
                    <li className="flex items-start">
                        <span className="mr-2">&#8226;</span>
                        <p className="text-sm sm:text-2xl text-white font-semibold text-left">
            ...
            <div className="p-1 m-5 border-y-2 border-black flex mx-10 items-center justify-center">
                <h1 className="text-4xl sm:text-7xl font-bold relative z-20 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-red-500 py-8">ABOUT
                    MATES</h1>
            </div>
